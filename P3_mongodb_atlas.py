...
CONNECTION_STRING = "mongodb+srv://anggie_user:autonoma2026@yape-case.lbhw0si.mongodb.net/?appName=Yape-Case"
...
# Limpiar para que la evidencia sea repetible y no duplique documentos.
...
for r in comerciantes.aggregate(pipeline_reporte):
    print(
        f"{r['tipo_comercio']:<20} {r['total_comercios']:>9} "
