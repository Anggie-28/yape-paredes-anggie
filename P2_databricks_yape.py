...
# ============================================================
# PARTE B - Pipeline de Transacciones Yape en Databricks
...
spark.sql("CREATE DATABASE IF NOT EXISTS db_yape")
df_bronze.write.mode("overwrite").saveAsTable("db_yape.bronze_transacciones")
...
# ============================================================
df_bronze = spark.table("db_yape.bronze_transacciones")
...
df_silver.write.mode("overwrite").saveAsTable("db_yape.silver_transacciones_limpias")
...
# ============================================================
df_silver = spark.table("db_yape.silver_transacciones_limpias")
...
spark.sql("DROP TABLE IF EXISTS db_yape.gold_top_distritos")
spark.sql("DROP TABLE IF EXISTS db_yape.gold_ingresos_por_hora")

gold_distritos.write.mode("overwrite").saveAsTable("db_yape.gold_top_distritos")
gold_comisiones.write.mode("overwrite").saveAsTable("db_yape.gold_ingresos_por_hora")
...
df_gold_distritos = spark.table("db_yape.gold_top_distritos").toPandas()
df_gold_comisiones = spark.table("db_yape.gold_ingresos_por_hora").toPandas()
